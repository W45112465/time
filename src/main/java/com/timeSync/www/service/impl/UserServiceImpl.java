...
public class UserServiceImpl implements UserService {
  ...
  public List<HashMap> selectUserPhotoAndName(List param) {
    return tbUserMapper.selectUserPhotoAndName(param);
  }

  @Override
  public String searchUserHiredate(int status) {
    return tbUserMapper.searchUserHiredate(status);
  }
  ...
  @Override
  public HashMap signInManagement(String userId) {
    return tbUserMapper.signInManagement(userId);
  }
}
